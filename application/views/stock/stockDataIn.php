                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="text-right">
                                <a href="<?= base_url('stock/in/add_stock') ?>" class="btn btn-primary btn-flat m-2"><i class="fas fa-plus"></i>Create</a>
                            </div>
                                        ...
                                        <?php foreach ($stock as $stck => $data) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a data-toggle="modal" data-target="#seeDetail" href="<?= base_url('stock/in/detailStockIn/' . $data->id_stock); ?>" class="btn btn-warning btn-xs viewDetail" width="200px" data-barcode="<?= $data->barcode ?>" data-item="<?= $data->itemsName ?>" data-detail="<?= $data->detail ?>" data-suplier="<?= $data->suplierName ?>" data-qty="<?= $data->qty ?>" data-date="<?= $data->date ?>"><i class="far fa-eye"></i> Detail</a>
                                                    <button data-delete="<?= $data->id_stock; ?>" class="btn btn-danger btn-xs deleteStockIn" width="200px"><i class="fas fa-trash"></i> Delete</button>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
